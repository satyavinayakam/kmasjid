@section('dashboard-header')
    ...
    <head>
        ...
        <title>K-masjid | Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-mini"><img src="dist/img/logo-s.png"></span>
                <!-- logo for regular state and mobile devices -->
                <!--      <span class="logo-lg"><b>K-</b>Masjid</span>-->
                <span class="logo-lg"><img src="dist/img/logo-p.png"></span>
            </a>
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="dist/img/avatar4.png" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Reviewers
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="/urus-masjid"><i class="fa fa-map-marker"></i> <span>Urus Masjid</span>
                        </a>
                    </li>
                    <li>
