...
(/** @lends <global> */function( $ ) {
	 ...
	 * [DataTables.net](href="datatables.net).
	 *
		...
		for ( i=0, ien=settings.aoData.length ; i<ien ; i++ ) {
			...
			if ( ! row._aFilterData ) {
				...
				for ( j=0, jen=columns.length ; j<jen ; j++ ) {
					...
					// method used here is much faster jsperf.com/html-decode
	 ...
	 * only for non-release builds. See semver.org/ for more information.
	 *  @member
	 *  @type string
	...
	DataTable.defaults = {
		 ...
		 * [jQuery.ajax](api.jquery.com/jQuery.ajax/) allowing fine control
