...
(function(factory) {
    ...
    // stackoverflow.com/questions/2161159/get-script-path
    ...
    var NiceScrollClass = function(myopt, me) {
        ...
        if (this.ishwscroll) {
            ...
            //this one can help to enable hw accel on ios6 indiegamr.com/ios6-html-hardware-acceleration-changes-and-how-to-fix-them/
            if (cap.hastranslate3d && cap.isios) this.doc.css("-webkit-backface-visibility", "hidden"); // prevent flickering stackoverflow.com/questions/3461441/      

            //derived from stackoverflow.com/questions/11236090/
        ...
        //inspired by forum.jquery.com/topic/width-includes-border-width-when-set-to-thin-medium-thick-in-ie
            ...
            if (this.doc[0].nodeName == 'IFRAME') {
                function oniframeload(e) {
                    ...
                    if (cap.isios && self.haswrapper) {
                        ...
                        }); // avoid iFrame content clipping - thanks to blog.derraab.com/2012/04/02/avoid-iframe-content-clipping-with-css-transform-on-ios/
                    }
...
*/
        ...
        // Thanks to www.switchonthecode.com !!
...
*/
    ...
    // webpro.host.adobe.com/people/jblas/momentum/includes/jquery.momentum.0.7.js  
